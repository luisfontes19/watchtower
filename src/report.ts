...
export const generateHTMLReport = (findings: Finding[], partial: boolean = false, includeTrustActions: boolean = false) => {
...
<body>
    ...
    <hr/>
    ${findingsHtml}
    ${includeTrustActions ? generateTrustActionsHTML() : ''}
    <hr/>
 ...
 */
export const generateTrustActionsHTML = (): string => {
    ...
    let html = `
        <div class="actions" style="margin-top: 20px; padding-top: 20px; border-top: 1px solid #333;">
            ...
            <button class="button" onclick="trustProject()" style="background: #007acc; color: white; padding: 8px 16px; border: none; border-radius: 4px; cursor: pointer; margin-right: 10px; font-family: inherit;">Trust This Project</button>
            <p style="margin-top: 8px; color: #9e9e9e; font-size: 0.9em;"><small>Trusting this project will disable future security scans for this workspace.</small></p>`
